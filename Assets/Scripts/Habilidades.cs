...
public class Habilidades
{
    ...
    public static Habilidad Curacion = new Habilidad("Curacion", "El usuario canaliza energia divina para sanar a un aliado", "sagrado", 3000, 50 , 50, 5, 0.0f, false, true, true, false);
